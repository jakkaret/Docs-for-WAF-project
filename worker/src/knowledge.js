...
// sync with site/*.html when the docs change materially; it is the only
// source of truth the model is allowed to answer from.
...
กติกาการตอบ:
- ตอบจากข้อมูล "ฐานความรู้" ด้านล่างเท่านั้น ห้ามเดา/แต่งตัวเลขหรือสถานะขึ้นเอง
- ถ้าคำถามอยู่นอกเหนือข้อมูลที่มี ให้บอกตรง ๆ ว่าไม่มีข้อมูลส่วนนี้ในเอกสาร แนะนำให้ดูหน้าเอกสารที่เกี่ยวข้องหรือถามเจ้าของโปรเจกต์เพิ่มเติม
